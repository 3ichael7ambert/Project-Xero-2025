...
//The main gravity calculation happens in the drawing event lol
if landed = false {
    air_gravity();
}
else {
...
if (facing_right)
{
	...
	if walk=false && idle=true {
		draw_sprite_ext(sprArmArms, image_index, nx_armB, ny_armB, scale, scale, image_angle-65+hsp, -1, 1);
		draw_sprite_ext(sprFist, image_index, nx_fistB, ny_fistB, scale, scale, image_angle-65+hsp, -1, 1); ///
		draw_sprite_ext(sprLeg3, image_index, nx_legB, ny_legB, scale, scale, image_angle, -1, 1);
	}
	if walk=true && idle=false {
		draw_sprite_ext(sprArmWalk, walk_armB, nx_armB, ny_armB, scale, scale, image_angle, -1, 1);
		draw_sprite_ext(sprLeg2, walk_legB, nx_legB, ny_legB, scale, scale, image_angle, -1, 1);
	...
	if walk=false && idle=true {
		...
		draw_sprite_ext(sprLeg3, image_index, nx_legF, ny_legF, scale, scale, image_angle, -1, 1);
	}
	if walk=true && idle=false {
			if weapon=0 {
				draw_sprite_ext(sprArmWalk, walk_armF, nx_armF, ny_armF, scale, scale, armF_dir, -1, 1);
			}
		draw_sprite_ext(sprLeg2, walk_legF, nx_legF, ny_legF, scale, scale, image_angle, -1, 1);
	}
}
else
{
...
if (facing_right)
{
	...
	draw_sprite_ext(sprLeg, image_index, x+(25*scale)-offsetX, y+offsetY, scale, scale, image_angle, -1, 1);
	...
	if weapon=0 {
		draw_sprite_ext(sprFist, image_index, nx_fistF-offsetX, ny_fistF+offsetY, scale, scale, armF_dir, -1, 1); ///
	}
	if weapon=1 {
		draw_sprite_ext(sprGun, image_index, nx_fistF-offsetX, ny_fistF+offsetY, scale, scale, armF_dir, -1, 1); ///
	}
	
	draw_sprite_ext(sprLeg, image_index, nx_legF-offsetX, ny_legF+offsetY, scale, scale, image_angle, -1, 1);
}
else
{
	draw_sprite_ext(sprArmArms, image_index, nx_armB-offsetX, ny_armB+offsetY, -scale, scale, image_angle+65-hsp, -1, 1);
	...
	if weapon=0 {
		draw_sprite_ext(sprFist, image_index, nx_fistF-offsetX, ny_fistF+offsetY, -scale, scale, armF_dir+180, -1, 1); ///
	}
	if weapon=1 {
		draw_sprite_ext(sprGun, image_index, nx_fistF-offsetX, ny_fistF+offsetY, -scale, scale, armF_dir+180, -1, 1); ///
	}
	draw_sprite_ext(sprLeg, image_index, nx_legF-offsetX, ny_legF+offsetY, -scale, scale, image_angle, -1, 1);

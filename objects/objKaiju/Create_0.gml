...
// ---------- ROOT DEFAULTS ----------
role = KaijuRole.ROOT; is_root = true; parent_ref = noone;
...
dragon_seg_count = 0;
if (!variable_instance_exists(self, "kaiju_mode")) kaiju_mode = "mech";
var root_id = id;
...
// ===========================
    ...
    // Head (direct assignment avoids with-scope issues)

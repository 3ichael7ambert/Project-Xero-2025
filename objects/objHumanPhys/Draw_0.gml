...
var shy = y + (shoulder_ofs.y * S);

// simple 2-bone aiming arm (elbow follows line)
var epx = shx + lengthdir_x(elbow_len * S, aim_ang);
var epy = shy + lengthdir_y(elbow_len * S, aim_ang);
var hx  = epx + lengthdir_x(hand_len  * S, aim_ang);
var hy  = epy + lengthdir_y(hand_len  * S, aim_ang);

// legs (simple sine stride for look)
var hipx = x + hip_ofs.x * S;
var hipy = y + hip_ofs.y * S;
var stride = sin(degtorad(walk_cycle)) * 10 * S;
var knee_ang_b = 260 + stride; // back leg
var knee_ang_f = 280 - stride; // front leg

var kbx = hipx + lengthdir_x(leg_len * S, knee_ang_b);
var kby = hipy + lengthdir_y(leg_len * S, knee_ang_b);
var kfx = hipx + lengthdir_x(leg_len * S, knee_ang_f);
var kfy = hipy + lengthdir_y(leg_len * S, knee_ang_f);

var fbx = kbx + lengthdir_x(foot_len * S, 270);
var fby = kby + lengthdir_y(foot_len * S, 270);
var ffx = kfx + lengthdir_x(foot_len * S, 270);

...
if weapon=0 { //FIST
	...
	//
	//
	var x_start = nx_fistF+lengthdir_x(110*scale,19+armF_dir); // Starting x-coordinate (e.g., laser's current position)
    var y_start = ny_fistF+lengthdir_y(110*scale,19+armF_dir); // Starting y-coordinate (e.g., laser's current position)
    var laser_angle = armF_dir; // Initial angle of the laser in degrees

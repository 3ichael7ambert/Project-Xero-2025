...
if ((place_meeting(x + 64, y, obj_block3D) || place_meeting(x + 64, y, obj_block3D)) && y > room_height / 2) {
    for (var i = 0; i < 10; i++) {
        ...
        draw_sprite_3d_matrix(sprSidewalk, 0, x, y, -64, 45, 0, 0);
    }
}
...
if ((place_meeting(x + 64, y, obj_block3D) || place_meeting(x + 64, y, obj_block3D)) && y < room_height / 2) {
    for (var i = 0; i < 10; i++) {
        draw_sprite_3d_matrix(sprSidewalk, 0, x, y, i * 64, 90, 0, 0);
        draw_sprite_3d_matrix(sprSidewalk, 0, x, y, -64, 135, 0, 0);
    }
}
...
if (place_meeting(x, y + 64, obj_block3D) && x < room_width / 2) {
    for (var i = 0; i < 10; i++) {
		...
		draw_sprite_3d_matrix(sprSidewalk, 0, x, y, -64, 0, -135, 0); //45degree
    }
}
...
if (place_meeting(x, y + 64, obj_block3D) && x > room_width / 2) {
    for (var i = 0; i < 10; i++) {
        ...
        draw_sprite_3d_matrix(sprSidewalk, 0, x + 64, y, -64, 0, -45, 0); //45degree
    }
}

/// @description  fake3D_draw_block(x,y,top_sprite, top_index, sidedown_sprite, sidedown_index, sideleft_sprite, sideleft_index, sideright_sprite,sideright_index, sideup_sprite,sideup_index, height, alpha);
/// @param x
/// @param y
/// @param top_sprite
/// @param  top_index
...
/// @param  height
/// @param  alpha
function fake3D_draw_block_ext() {

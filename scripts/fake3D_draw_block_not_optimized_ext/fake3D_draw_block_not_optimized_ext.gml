/// @description  fake3D_draw_block_not_optimized_ext(x,y,top_sprite, top_index, sidedown_sprite, sidedown_index, sideleft_sprite, sideleft_index, sideright_sprite,sideright_index, sideup_sprite,sideup_index, height, alpha);
/// @param x
/// @param y
/// @param top_sprite
/// @param  top_index
/// @param  sidedown_sprite
/// @param  sidedown_index
/// @param  sideleft_sprite
/// @param  sideleft_index
/// @param  sideright_sprite
/// @param sideright_index
/// @param  sideup_sprite
/// @param sideup_index
/// @param  height
/// @param  alpha
function fake3D_draw_block_not_optimized_ext() {
